...
public class TranslateTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        GoogleAPI.setKey(Files.read(new File(System.getProperty("user.home") + "/.google.com/macros/s/AKfycbytdxxS4cKrv9XyO3NbE2SgPMw7q8Qp3W_0RR-VBDLqvutXta76uJUEZvCeov222P55Kg/exec")).trim());
    ...
    public void testTranslate() throws Exception {
        ...
        assertEquals("????", translate.execute("Hello world", Language.ENGLISH, Language.CHINESE));
        ...
        assertEquals("???? ??????", translate.execute("Hello world", Language.ENGLISH, Language.HINDI));
        assertEquals("Ciao mondo", translate.execute("Hello world", Language.ENGLISH, Language.ITALIAN));
        assertEquals("???????", translate.execute("Hello world", Language.ENGLISH, Language.JAPANESE));
        assertEquals("????? ??", translate.execute("Hello world", Language.ENGLISH, Language.KOREAN));
        assertEquals("Olá Mundo", translate.execute("Hello world", Language.ENGLISH, Language.PORTUGUESE));
        assertEquals("?????? ???", translate.execute("Hello world", Language.ENGLISH, Language.RUSSIAN));
        ...
        assertEquals("????????????", translate.execute("Hello world", Language.ENGLISH, Language.THAI));
        assertEquals("Selam Dünya", translate.execute("Hello world", Language.ENGLISH, Language.TURKISH));
        assertEquals("Hola Mundo", translate.execute("?????? ???", Language.RUSSIAN, Language.SPANISH));
    ...
    public void testUnHtmlEntities() throws Exception {
        ...
        assertEquals("?????", translate.execute("ID", Language.ENGLISH, Language.HEBREW));
    }
