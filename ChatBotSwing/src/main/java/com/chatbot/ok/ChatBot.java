...
import static com.chatbot.ok.GUI.userMsg;
...
public class ChatBot {
	...
	GoogleTranslateAPI gtran = new GoogleTranslateAPI();
	...
	String reply;
	public ChatBot(){
		statements.add("I now understand spanish!!\nHello, I'm the bookOwl your personal entertainment assistant"); //0
	...
	public void loopGeneraTitle(Person person,PCA pca, ArrayList<String> suggest, boolean last) throws InterruptedException, IOException {
		...
		for (String s: suggest) {
			...
			GUI.getUserIN();
			reply = gtran.Translate(GUI.userMsg);
