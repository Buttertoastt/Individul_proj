...
public class WikiAPI {
    ...
    public static ArrayList<Page> query(String input, int threshold) {
        ...
        String format_input = input.replaceAll("", "%40");
...
/*
    public static void main(String[] args) throws Exception {
        new SpringApplicationBuilder(WikiAPI.class).headless(false).run(args);
        GoogleTranslateAPI gtrans = new GoogleTranslateAPI();
        System.out.println(gtrans.Translate("Hello, my name is David."));

        //WikiAPI wiki = new WikiAPI();

        Page p = WikiAPI.getRandomPage("fiction");
        Page p2 = WikiAPI.getRandomPage("non-fiction");
        ...
        System.out.println(p2.getURL());
        System.out.println(p2.getWordCount());
        System.out.println(p2.getExtract());
    }
    }
    */
